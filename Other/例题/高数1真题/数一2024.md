...
-  $\displaystyle  \iint_{D_0} \frac{x+y}{\sqrt{x^2+y^2}} dxdy = \iint_{D_0} \frac{r(\cos\theta+\sin\theta)}{r} \cdot r drd\theta \xlongequal[]{\text{note}r}\iint_{D_0} (\cos\theta+\sin\theta) \cdot r drd\theta$
	- $\displaystyle  \xlongequal[]{\text{note}}\int_0^{\frac{\pi}{4}} (\cos\theta+\sin\theta) d\theta\underbrace{\int_1^{\sec\theta} r dr}_{\frac{\sec^2\theta-1}{2}} \xlongequal[]{\int r d r=\frac{r^2}{2}} \int_0^{\frac{\pi}{4}} (\cos\theta+\sin\theta) \cdot \frac{\sec^2\theta-1}{2} d\theta$
	- $\displaystyle  \xlongequal[]{\text{note}} \frac{1}{2} \int_0^{\frac{\pi}{4}} (\cos\theta+\sin\theta)(\sec^2\theta-1) d\theta$
	- $\displaystyle \xlongequal[]{\text{expand}} \frac{1}{2} \int_0^{\frac{\pi}{4}} (\sec\theta-\cos\theta+\underbrace{\frac{\sin\theta}{\cos^2\theta}}_{-\sin \theta=(\cos \theta)^{\prime}}-\sin\theta) d\theta$
...
- $\displaystyle$取上侧方向，那么$\int_{\Gamma}\left(6 x y z-y z^2\right) \mathrm{d} x+2 x^2 z \mathrm{~d} y+x y z \mathrm{~d} z$
	...
	- $\displaystyle \xlongequal[]{\text{simplify}}\iint_{\sum}\left(4x^2-2xz\right)+\left(z^2-2xz\right) dxdy$
	- $\displaystyle \xlongequal[]{\text{simplify}}\iint_{\sum}(2x-z)^2 dxdy$
...
- 由斯托克斯公式:空间线转空间面<br>$\displaystyle I=\iint_{\Sigma}\left|\begin{array}{ccc}\cos \alpha & \cos \beta & \cos \gamma \\ \frac{\partial}{\partial x} & \frac{\partial}{\partial y} & \frac{\partial}{\partial z} \\ P & Q & R\end{array}\right| d S\xlongequal[]{\cos \alpha = \frac{-2}{\sqrt{5}},  \cos \beta = 0,  \cos \gamma = \frac{1}{\sqrt{5}}}\iint_{\Sigma}\left|\begin{array}{ccc}\frac{-2}{\sqrt{5}} & 0 & \frac{1}{\sqrt{5}} \\ \frac{\partial}{\partial x} & \frac{\partial}{\partial y} & \frac{\partial}{\partial z} \\ 6 x y z-y z^2 & 2 x^2 z & x y z\end{array}\right| d S$
	...
	- $\displaystyle =\iint_{\Sigma} \frac{1}{\sqrt{5}}(2 x-z)^2 d S\xlongequal[\text{note}xOy\text{note}:ds=\sqrt{1+z_x^{\prime 2}+z_y^{\prime 2}}]{\text{note}:2x - z =1 }\iint_{Dxy} \frac{1}{\sqrt{5}} \cdot 1^2 \cdot \underbrace{\sqrt{1+z_x^{\prime 2}+z_y^{\prime 2}}}_{\sqrt{1+2^2+1^2}=\sqrt{5}}d x d y$
