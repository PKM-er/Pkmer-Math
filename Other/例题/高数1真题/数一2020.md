...
#### 2025版
- <br>![|200](/_assert_/Images/20241208143951.png)
- (1) 两个事件的加法公式:
...
### (16)
- <br>![|200](/_assert_/Images/20241208204722.png)
- 拿到一个平面，如何选取方法，
...
- 两类曲面积分之间的联系<br>$\iint_{\Sigma} P \mathrm{~d} y \mathrm{~d} z+Q \mathrm{~d} z \mathrm{~d} x+R \mathrm{~d} x \mathrm{~d} y=\iint_{\Sigma}(P \cos \alpha+Q \cos \beta+R \cos \gamma) \mathrm{d} S,$
 ...
 - <br>![|300](/_assert_/Images/20241208201552.png)
...
- 思路<br>![|500](/_assert_/Images/20241208195108.png)
