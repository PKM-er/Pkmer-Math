...
- 通过画图来判断函数f(x)是否是极值点
	...
	- 于是 $\begin{aligned} x \in (-\delta, \delta) \end{aligned}$ 时，有 $\begin{aligned} f(x) < f(0) \end{aligned}$，这是极大值<br>![|200](20241209080025.png)
- 答 应选 B.
## (3)
