...
- 通过画图来判断函数f(x)是否是极值点
	...
	- 于是 $\begin{aligned} x \in (-\delta, \delta) \end{aligned}$ 时，有 $\begin{aligned} f(x) < f(0) \end{aligned}$，这是极大值<br>![|200](/_assert_/Images/20241209080025.png)
- 答 应选 B.
## (3)
...
- <br>![|600](/_assert_/Images/20241209094427.png)
## (7)
...
- <br>![|200](/_assert_/Images/20241209100831.png)
- 结论:选项 (A) 正确
# 二、填空题
...
- <br>![|200](/_assert_/Images/20241209105321.png)
 答 应填 $\frac{32}{3}$.
...
- <br>![|200](/_assert_/Images/20241209201106.png)
...
- <br>![|300](/_assert_/Images/20241209203344.png)
