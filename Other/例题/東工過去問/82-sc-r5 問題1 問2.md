...
$$
\begin{bmatrix} -1 & \sqrt{3} \\ \sqrt{3} & -3 \end{bmatrix} \begin{bmatrix} x_1 \\ x_2 \end{bmatrix} = 0 \Rightarrow x_1 = \sqrt{3} x_2 \Rightarrow \text{note} \begin{bmatrix} \sqrt{3} \\ 1 \end{bmatrix}
$$
...
$$
\begin{bmatrix} 3 & \sqrt{3} \\ \sqrt{3} & 1 \end{bmatrix} \begin{bmatrix} y_1 \\ y_2 \end{bmatrix} = 0 \Rightarrow y_1 = -\sqrt{3} y_2 \Rightarrow \text{note} \begin{bmatrix} -\sqrt{3} \\ 1 \end{bmatrix}
$$
