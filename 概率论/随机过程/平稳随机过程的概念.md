...
众多平稳性是根据[[相关函数]]来建立的，所以有必要先介绍相关函数的定义。
...
常见的增量平稳过程有[[维纳过程|布朗运动]]
$$B\left(t\right)-B\left(s\right)\sim \mathrm{N}\left(0,t-s\right)$$
和[[泊松过程]]
$$N\left(t\right)-N\left(s\right)\sim\mathrm{Poisson}\left(\lambda\left(t-s\right)\right)$$