...
author:
  - PaulSun
---
相关函数我们主要研究的是[[平稳随机过程的概念|宽平稳随机过程]]的相关函数，即能被记作 $R\left(t-s\right)$ 或 $R\left(\tau\right)$ 的相关函数，这样的相关函数具有五条基本性质和正定性。
...
$$\left(R\left(t_i-t_j\right)\right)_{ij}=\left(\mathrm E\left(X\left(t_i\right)X\left(t_j\right)\right)\right)_{ij}=\mathrm E\left(XX^T\right)=R
$$
