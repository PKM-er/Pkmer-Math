...
$$
仅当 $c_1 = 0$ 且 $c_2 = 0$ 时成立，则称 $\mathbf{v}_1$ 和 $\mathbf{v}_2$ 线性独立。
...
1. 如果 $A$ 的列向量是 $\mathbf{v}_1, \mathbf{v}_2, \ldots, \mathbf{v}_n$，则 $A$ 的[[矩阵的秩|秩]]等于列向量的个数，意味着这组向量是线性独立的。
