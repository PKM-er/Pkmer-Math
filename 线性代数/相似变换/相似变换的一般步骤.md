...
author:
  - Cyletix
---
相似变换的目标是把矩阵化为最简单的形式：能[[对角化]]时化为对角矩阵，不能对角化时化为[[Jordan标准型]]。一般步骤如下：
...
4. 如果可以对角化
	...
	2. 相似变换得到[[对角矩阵]]D
5. 如果不能对角化
	1. 构造[[Jordan标准型|Jordan块]]
	2. 求解[[Jordan标准型|广义特征向量]]
	3. 构造[[相似变换矩阵]]P
...
5. **求解广义特征向量**: 
- 对于$\lambda_1 = 4$: 
取特征向量 $v_1=\begin{bmatrix}1\\0\end{bmatrix}$，再求 $v_2$ 满足
$$
(B-4I)v_2=v_1.
$$
可取
