...
author:
  - Cyletix
urlink: https://zh.wikipedia.org/wiki/%E7%BA%BF%E6%80%A7%E6%97%A0%E5%85%B3
---
**一次独立**（即[[向量组的线性相关性|线性无关]]）是指一个向量组中，任意一个向量不能由其他向量的线性组合表示。换句话说，如果一个向量组中的每个向量的线性组合为零向量时，所有系数都必须为零，那么这个向量组就是线性无关的。

在带[[内积]]的空间中，已知向量两两内积时，可以构造[[格拉姆矩阵]]判定线性无关——这种途径比消元法更几何。
...
总结：在带内积的空间中，通过构造格拉姆矩阵并验证其行列式不为零，可以证明该向量组线性无关。
