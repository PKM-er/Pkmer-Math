import{_ as l,c as p,b as e,d as n,a as i,e as t,r as d,o as r}from"./app-6dQ5mgl-.js";const h={};function o(c,s){const a=d("Tikz");return r(),p("div",null,[s[0]||(s[0]=e(`<h1 id="简介" tabindex="-1">简介</h1><h2 id="环境配置" tabindex="-1">环境配置</h2><p>代码类型: tikz</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>\\usepackage{tikz}</span></span>
...
\\end{tikzpicture}
\\end{document}
`}),s[1]||(s[1]=i("h3",{id:"三角形",tabindex:"-1"},"三角形",-1)),n(a,{data:`\\begin{document}
\\begin{tikzpicture}
    % 坐标轴
...
\\end{tikzpicture}
\\end{document}
`}),s[2]||(s[2]=i("h3",{id:"不规则多边形填充",tabindex:"-1"},"不规则多边形填充",-1)),s[3]||(s[3]=i("p",null,[t("利用指定轮廓线进行 "),i("code",null,"clip"),t(", 从而避免了不规范的遮挡操作")],-1)),n(a,{data:`\\usepackage{tikz}
\\begin{document}
...
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">\\end</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">{</span><span style="--shiki-light:#383A42;--shiki-light-font-style:inherit;--shiki-dark:#E06C75;--shiki-dark-font-style:italic;">document</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h1 id="案例" tabindex="-1">案例</h1><h2 id="_2d" tabindex="-1">2D</h2>`,19)),n(a,{data:`\\begin{document}
\\begin{tikzpicture}
% 绘制坐标轴
...
\\end{tikzpicture}
\\end{document}
`}),s[6]||(s[6]=i("h2",{id:"_3d",tabindex:"-1"},"3D",-1)),s[7]||(s[7]=i("p",null,[i("strong",null,[t("必须需要导入 "),i("code",null,"\\usepackage{tikz-3dplot}"),t(" 包!")])],-1)),n(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
...
\\end{tikzpicture}
\\end{document}
`}),s[8]||(s[8]=i("p",null,"真实边缘轮廓的角度为 \\tdplotsetmaincoords{80}{120} 后者120和其补角: 120+180, 这两个线是真实视角边缘轮廓线",-1)),n(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
   % 设置 3D 视角
...
\\end{tikzpicture}
\\end{document}
`}),s[11]||(s[11]=i("h3",{id:"标准旋转体填充",tabindex:"-1"},"标准旋转体填充",-1)),s[12]||(s[12]=i("p",null,"以后旋转体都严格按照这个模式进行",-1)),n(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
...
\\end{tikzpicture}
\\end{document}
`}),s[13]||(s[13]=i("h2",{id:"树状图",tabindex:"-1"},"树状图",-1)),s[14]||(s[14]=i("h3",{id:"纵向",tabindex:"-1"},"纵向",-1)),n(a,{data:`\\begin{document}
\\begin{tikzpicture}
    % 根节点
    \\node {$z$}
        child {node {$x$} 
...
\\end{tikzpicture}
\\end{document}
`}),s[15]||(s[15]=i("h3",{id:"横向",tabindex:"-1"},"横向",-1)),n(a,{data:`\\begin{document}
\\begin{tikzpicture}[
    grow=right, % 让树从左向右生长
...
\\end{tikzpicture}
\\end{document}
`}),s[17]||(s[17]=i("hr",null,null,-1)),s[18]||(s[18]=i("h2",{id:"其他案例",tabindex:"-1"},"其他案例",-1)),s[19]||(s[19]=i("p",null,[t("一个失败的案例, 原因是忘记导入 "),i("code",null,"\\usepackage{tikz-3dplot}"),t(" 包了, 加上就好")],-1)),n(a,{data:`\\usepackage{tikz-3dplot}
\\begin{document}
\\begin{tikzpicture}
    % 设置 3D 视角
    \\tdplotsetmaincoords{70}{120}
...
\\end{tikzpicture}
\\end{document}
`}),s[20]||(s[20]=i("h2",{id:"automaton",tabindex:"-1"},"Automaton",-1)),s[21]||(s[21]=i("h3",{id:"tikz绘制自动机的状态转移图示例",tabindex:"-1"},"tikz绘制自动机的状态转移图示例:",-1)),n(a,{data:`\\usepackage{tikz}
...
\\end{tikzpicture}
\\end{document}
`}),s[22]||(s[22]=i("h3",{id:"多边形",tabindex:"-1"},"多边形",-1)),n(a,{data:`\\usepackage{tikz}
...
`}),s[23]||(s[23]=i("h3",{id:"example",tabindex:"-1"},"example",-1)),n(a,{data:`\\usepackage{tikz}
