...
本系列内容亦在用通俗的语言描述 梳理高等数学的主要内容, 整理为Obsidian风格的markdown文件, 内容上会使用大量Obsidian特色风格语法, 包括但不限于: 
- 使用Obsidian双链语法, 组织目录和相关内容, 构成一个Obsidian的数学知识网络.
- 使用Callout语法, 为重点内容制作简易美观的卡片. 
- 使用块引用语法, 引用原子化的内容组织更高层文章
由于开发者精力有限, 如有内容疏漏错误 欢迎补充和指出. 
希望共同开发的场合, 请联系开发者, 加群. 
