...
---
## 公告
- 2026-08-14：仓库预计新增大量进阶内容, 并发布了release, 现在使用不需要再clone整个仓库, 直接下载最新release的zip即可
- 2026-03-22：仓库已进行一次**历史重写**，清理了 `_assets_` 与 `.obsidian` 的旧历史，仅保留当前最新状态快照。
	- 如果你之前已经 `clone` 本仓库，或你的 `fork` 需要同步上游，请先阅读：[历史重写后的同步说明](Other/说明/历史重写后的同步说明.md)
	- 个人草稿等本地文件不要追加到共享 `.gitignore`；请使用 `.git/info/exclude`，详见：[本地排除文件](Other/说明/本地排除文件.md)
...
- [高等数学](Other/-高等数学-.md) (**重点**, 主体开发完毕,细节需完善)
	...
	- [概率论](概率论/--概率论--.md)
		...
		3. [随机变量函数](概率论/随机变量函数/---随机变量函数---.md)
		4. [极限定理](概率论/极限定理/---极限定理---.md)
		5. [抽样分布](概率论/抽样分布/---抽样分布---.md)
		6. [参数估计](概率论/参数估计/---参数估计---.md)
		7. [假设检验](概率论/假设检验/---假设检验---.md)
		8. [方差分析及回归](概率论/方差分析及回归/---方差分析及回归---.md)
		9. [随机过程](概率论/随机过程/---随机过程---.md)
...
- [本地排除文件](Other/说明/本地排除文件.md)
- [历史重写后的同步说明](Other/说明/历史重写后的同步说明.md)
