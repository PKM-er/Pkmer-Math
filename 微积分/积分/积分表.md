...
$$
\int \frac{1}{x \sqrt{1 - x^2}} \, dx = -\ln\frac{1 + \sqrt{1 - x^2}}{x} + C = -\text{arcsech}(x) + C \quad (0 < x < 1)
$$

$$
\int \frac{1}{|x| \sqrt{1 + x^2}} \, dx = -\text{arccsch}(x) + C \quad (x \neq 0)
$$
---
反圆锥曲线函数与对数函数的统一
![[反圆锥曲线函数与对数函数的统一#总结]]