...
author:
  - Cyletix
---
无界函数的反常积分是[[反常积分]]的一种，涉及在积分区间或被积函数中存在无界性的情况。
...
这里的 $\varepsilon$ 是一个趋近于0的正数，通过这种方式，我们可以“绕过”$c$ 点的无界性。

## 示例
考虑计算反常积分$\displaystyle \int_0^1 \frac{1}{\sqrt{x}} \, dx$。函数$\displaystyle \frac{1}{\sqrt{x}}$在$x = 0$处无界。
